...
<body>
  <div>
    ...
    <div class="mt-2">
        <span>
            <a href="http://localhost/Store/?quanly=home" class="no-underline">
      ...
      <div class="prominentAccessory rounded mt-3.5">
            ...
            <ul class="p-0 pt-2 m-0 ">
                <div class="mayBeLike">
                    ...
                    <a href="http://localhost/Store/?quanly=productDetails&id=<?php echo $rowPa['id'];?>">
      ...
      <ul class="p-0 pt-2 m-0 flex flex-wrap justify-evenly">
        ...
        ?>
            ...
            <a href="http://localhost/Store/?quanly=productDetails&id=<?php echo $rowAcc['id'];?>">
