...
<div style="backgroundColor: #fafafa" class="mt-1">
    ...
    >
        ...
        <ul class="p-0 pt-2 m-0 ">
            <div class="mayBeLike">
                ...
                <a href="http://localhost/Store/?quanly=productDetails&id=<?php echo $row['id'];?>">
    ...
    >
        ...
        <ul class="p-0 pt-2 m-0 flex flex-wrap justify-evenly">
            ...
            ?>
                <a href="http://localhost/Store/?quanly=productDetails&id=<?php echo $rowAa['id'];?>">
    ...
    >
        ...
        <ul class="p-0 pt-2 m-0 flex flex-wrap justify-evenly">
            ...
            ?>
                <a href="http://localhost/Store/?quanly=productDetails&id=<?php echo $rowPp['id'];?>">
                <li class="itemA list-none p-2 m-px my-1.5 border rounded shadow-md relative hover:shadow">
    ...
    >
        ...
        <ul class="p-0 pt-2 m-0 ">
            <div class="mayBeLike ">
                ...
                ?>
                    <li class="itemA list-none p-2 border rounded shadow-md relative hover:shadow">
                    <a href="http://localhost/Store/?quanly=productDetails&id=<?php echo $rowPsh['id'];?>">
                        <!-- <div> -->
    ...
    >
        ...
        <ul class="p-0 pt-2 m-0 flex flex-wrap justify-evenly">
            ...
            ?>
                <a href="http://localhost/Store/?quanly=productDetails&id=<?php echo $rowIb['id'];?>">
                <li class="itemA list-none p-2 m-px my-1.5 border rounded shadow-md relative hover:shadow">
    ...
    <div class="customerOf rounded mt-5">
        <div
