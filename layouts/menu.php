...
<div>
      <ul class="menuContainer rounded z-30">
        <li class="itemContainer itemContainer1">
          <a href="http://localhost/Store/?quanly=phone">
            <div
              class="item item1"
            >
              ...
              <table>
                <tbody>
                  ...
                  <tr>
                    <td>
                      <ul>
                        <a href="http://localhost/Store/?quanly=apple"><li>Apple</li></a>
                        <li>Oppo</li>
                        <li>Realme</li>
                        <li>Infinix</li>
                      </ul>
        ...
        <li class="itemContainer">
          <a href="http://localhost/Store/?quanly=apple">
            <div
              class="item"
            >
        ...
        <li class="itemContainer itemContainer1">
          <a href="http://localhost/Store/?quanly=phukien">
            <div class="item">
        ...
        <li class="itemContainer itemContainer1">
          <a href="http://localhost/Store/?quanly=maytroi">
            <div class="item">
        ...
        <li class="itemContainer itemContainer1">
          <a href="http://localhost/Store/?quanly=suachua">
            <div class="item">
        ...
        <li class="itemContainer itemContainer1">
          <a href="http://localhost/Store/?quanly=dichvu">
            <div class="item">
        ...
        <li class="itemContainer">
          <a href="http://localhost/Store/?quanly=tinhot">
            <div class="item">
        ...
        <li class="itemContainer itemContainer1">
          <a href="http://localhost/Store/?quanly=uudai">
            <div class="item">
