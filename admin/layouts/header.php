...
<div class="header flex justify-between p-3">
      ...
      <?php 
        ...
        if($currentURL=="http://localhost/Store/admin/?action=dashboard"){
          echo"<p>Welcome to  Store</p>";
        }elseif($currentURL=="http://localhost/Store/admin/?action=products"){
          echo "<p>PRODUCTS</p>";
        }elseif($currentURL=="http://localhost/Store/admin/?action=orders"){
          echo "<p>ORDERS</p>";
        }elseif($currentURL=="http://localhost/Store/admin/?action=users"){
          echo "<p>USERS</p>";
        }elseif($currentURL=="http://localhost/Store/admin/?action=admin/profile"){
          echo "<p>ADMIN</p>";
        }elseif($currentURL=="http://localhost/Store/admin/?action=admin/change_password"){
          echo "<p>ADMIN</p>";
        }else {
          echo"<p>Welcome to  Store</p>";
        }
